...
// 刷屏测试>>>>>
	...
	for(i=0;i<8;i++)
	{
		...
		LCD_Clear();		// 清屏
		LCD_DisplayText(112, 84,"STM32H7B0 LTDC 刷屏测试");
		LCD_DisplayText(112,134,"核心板型号：FK7B0M1");
...
// 颜色测试>>>>>
	...
	LCD_DisplayText(42,70,"核心板型号：FK7B0M1");
...
// 绘制其它内容>>>>>>>		
	...
	LCD_DisplayText(40,500,   "STM32H7B0 LTDC 测试");	
	LCD_DisplayText(40,500+40,"核心板型号：FK7B0M1");	
